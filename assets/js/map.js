...
let StudyArea = new Image({
    title: "Study Area",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'geoserver_14:Study Area', 'STYLES': 'restricted' }
    })
});
var Group14DTM = new Image({
    title: "DTM",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:dtm' }
    }),
    opacity: 0.5,
    visible: false
});

var Group14dusaf = new Image({
    title: "dusaf",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:dusaf' }
    }),
    visible: false
});

var Group14ndvi = new Image({
    title: "ndvi",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:ndvi' }
    }),
    visible: false
});

var Group14population = new Image({
    title: "population",
    source: new ImageWMS({
      url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:population' }
    }),
    visible: false
});

var Group14rivers = new Image({
    title: "rivers",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:rivers' }
    }),
    visible: false
});

var Group14roads = new Image({
    title: "roads",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:roads' }
    }),
    visible: false
});

var Group14faults = new Image({
    title: "faults",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:faults' }
    }),
    visible: false
});

var Group14LandslideSusceptibilityMap = new Image({
    title: "Landslide Susceptibility Map",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:LandslideSusceptibilityMap' }
    }),
    visible: false
});

var Group14LandslideSusceptibilityMapRsample = new Image({
    title: "Landslide Susceptibility Resample Map",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:resampled' }
    }),
    visible: false
});

var Group14LandslideSusceptibilityMap_reclass = new Image({
    title: "LandslideSusceptibilityMap_reclass",
    source: new ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/gisgeoserver_14/wms',
        params: { 'LAYERS': 'gisgeoserver_14:LandslideSusceptibilityMap_reclass' }
    }),
    minResolution: 1000,
    maxResolution: 5000
});
...
let overlayLayers = new Group({
    ...
    layers: [
        ...
        Group14roads,
        Group14faults,
        Group14LandslideSusceptibilityMap,
        Group14LandslideSusceptibilityMap_reclass,
        Group14LandslideSusceptibilityMapRsample
    ]
})
